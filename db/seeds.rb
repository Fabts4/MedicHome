...
prescription_10 = Prescription.create!(date: '15/01/2023', status: 2, doctor_id: raoult.id, patient_id: edouard.id)
prescription_11 = Prescription.create!(date: '28/01/2023', status: 2, doctor_id: raoult.id, patient_id: edouard.id)
prescription_12 = Prescription.create!(date: '16/02/2023', status: 2, doctor_id: raoult.id, patient_id: edouard.id)
prescription_13 = Prescription.create!(date: '23/02/2023', status: 2, doctor_id: raoult.id, patient_id: edouard.id)
prescription_14 = Prescription.create!(date: '08/03/2023', status: 2, doctor_id: raoult.id, patient_id: edouard.id)
