...
prescription_1 = Prescription.create!(date: '06/03/2023', status: 0, doctor_id: doc_knock.id, patient_id: michel.id)
prescription_2 = Prescription.create!(date: '14/01/2022', status: 0, doctor_id: doc_knock.id, patient_id: michel.id)
prescription_3 = Prescription.create!(date: '30/08/2021', status: 0, doctor_id: doc_knock.id, patient_id: michel.id)
prescription_4 = Prescription.create!(date: '22/01/2020', status: 0, doctor_id: doc_knock.id, patient_id: michel.id)
prescription_5 = Prescription.create!(date: '28/02/2018', status: 0, doctor_id: doc_knock.id, patient_id: michel.id)
prescription_6 = Prescription.create!(date: '12/07/2022', status: 0, doctor_id: doc_knock.id, patient_id: michel.id)
prescription_7 = Prescription.create!(date: '14/07/2018', status: 0, doctor_id: raoult.id, patient_id: georges.id)
prescription_8 = Prescription.create!(date: '31/05/2020', status: 0, doctor_id: raoult.id, patient_id: georges.id)
prescription_9 = Prescription.create!(date: '30/11/2019', status: 0, doctor_id: raoult.id, patient_id: georges.id)
prescription_10 = Prescription.create!(date: '15/09/2022', status: 0, doctor_id: raoult.id, patient_id: georges.id)
...
pharmacy_9 = Pharmacy.create!(name: 'Pharmol', address: '1 rue de Montmartre, Paris')
